...
import 'package:to_do/utils/widgets/responsive_grid.dart';
...
class HomeViewWeb extends ConsumerWidget {
              ...
              child: Row(
                ...
                children: [
                    ...
                    child:SingleChildScrollView(
                     ...
                     todoData.value!=null&&todoData.value!.isNotEmpty? ResponsiveGridRow(
                          children: List.generate(todoData.value?.length??0, (index) => ResponsiveGridCol(
                            xl:ref.watch(addTaskProvider)==true? 6:4,
                            lg: ref.watch(addTaskProvider)==true? 6:4,
                            md: ref.watch(addTaskProvider)==true? 6:4,
                            xs: 12,
                            sm: 12,
                            child: Padding(
                 ...
                 const SizedBox(
                  ...
                  if(ref.watch(addTaskProvider)==true)
                  Expanded(
                    flex: 1,
